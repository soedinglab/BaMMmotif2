...
### This R script is used for reading in BaMM from bamm-formatted files.
### It is a prerequiste for the plotBaMM.R file. 
### Currently, the implemeneted alphabet is ACGT
